...
resource "aws_s3_bucket" "zenqms_bucket" {
...
resource "aws_s3_bucket_policy" "this" {
  ...
  bucket = aws_s3_bucket.zenqms_bucket[0].id
...
data "aws_iam_policy_document" "elb_log_delivery" {
  ...
  statement {
    ...
    resources = [
      "${aws_s3_bucket.zenqms_bucket[0].arn}/*",
    ]
  }
}
...
resource "aws_s3_bucket_public_access_block" "this" {
  ...
  bucket = local.attach_policy ? aws_s3_bucket_policy.this[0].id : aws_s3_bucket.zenqms_bucket[0].id
